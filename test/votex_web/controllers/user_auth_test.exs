defmodule VotexWeb.UserAuthTest do
  use VotexWeb.ConnCase, async: true

  alias Votex.Accounts
  alias VotexWeb.UserAuth
  import Votex.AccountsFixtures

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, VotexWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      VotexWeb.Endpoint.subscribe(live_socket_id)

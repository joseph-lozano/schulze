defmodule SchulzeWeb.UserAuthTest do
  use SchulzeWeb.ConnCase, async: true

  alias Schulze.Accounts
  alias SchulzeWeb.UserAuth
  import Schulze.AccountsFixtures

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, SchulzeWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      SchulzeWeb.Endpoint.subscribe(live_socket_id)
